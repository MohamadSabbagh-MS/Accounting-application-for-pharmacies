...
class insurance_company extends StatefulWidget {
  ...
  @override
  State<insurance_company> createState() => _insurance_companyState();
}
...
class _insurance_companyState extends State<insurance_company> {
  ...
  addIcom() async {
    var response = await _req.postRequset(linkAddIcom, {
      "name": Name.text,
      "phone": Phone.text,
