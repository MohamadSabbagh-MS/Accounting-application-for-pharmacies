...
class CustomTable_s_b_r extends StatefulWidget {
  const CustomTable_s_b_r({Key? key}) : super(key: key);

  @override
  State<CustomTable_s_b_r> createState() => _CustomTable_s_b_rState();
}
...
class _CustomTable_s_b_rState extends State<CustomTable_s_b_r> {
