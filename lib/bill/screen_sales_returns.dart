...
class sales_r extends StatefulWidget {
  _sales_rState createState() => _sales_rState();
}

@override
class _sales_rState extends State<sales_r> {
  ...
  Future<void> s() async {
    try {
      ...
      Map<String, dynamic>? responseData =
          await _req.postRequest1(linkSendJson2, data1);
      print(
