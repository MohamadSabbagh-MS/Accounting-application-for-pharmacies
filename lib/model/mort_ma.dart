...
class MortaM extends StatefulWidget {
  _MortaMState createState() => _MortaMState();
}

@override
class _MortaMState extends State<MortaM> {
  ...
  Future<void> GetMed() async {
    var response = await _req.postRequset(linkSelectMM, {
      "name": med.text,
      "user_id": sharedPref.getString("id"),
    });
    print("printer : ${response}");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('فاتورة مرتجع مبيعات'),
      ),
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (x) {
                                  ...
                                  controllerm[index].text =
                                      (int.parse(x) * MedData["price_m"])
                                          .toString();
                                  updateData1("amount1",
                                      (int.parse(x) * MedData["price_m"]));
                                  amountAll[index] =
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (x) {
                                  ...
                                  if (x.isNotEmpty) {
                                    ...
                                    updateData1(
                                        "price", int.parse(MedData["price_m"]));
                                  }
                                },
